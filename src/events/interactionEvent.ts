...
import { ContextInteractionHandler, SlashInteractionHandler, ButtonInteractionHandler, EventHandler } from '../lib/interactionHandler'
...
const interactionEvent: EventHandler = {
